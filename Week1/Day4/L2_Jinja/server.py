...
# WE NEVER USE THE ANGLE BRACKET SYNTAX IN ANY OTHER PART OF OUR FLASK APP. PERIOD. PERIOD.
...
def Show_Table():
    ...
    return render_template('data_table.html', pokemon_list=pokemon_list)
